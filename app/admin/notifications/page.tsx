    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <Bell className="text-primary w-7 h-7 mt-1" />
          <div>
            <h1 className="text-xl font-medium">Notification Center</h1>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-2">
                        <h3 className={`text-md font-medium font-black tracking-tight ${!notification.isRead ? 'text-foreground' : 'text-muted-foreground'}`}>
                          {notification.title}
                        </h3>
                        {!notification.isRead && (
                      ...
                      <span className="text-[12px] font-medium text-muted-foreground/60 uppercase">
                        {notification.time}
                      </span>
                    </div>
