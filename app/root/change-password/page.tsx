    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <Card className="border-border/60 shadow-sm">
        <CardHeader className="border-b border-border/40 bg-muted/20">
          ...
          <CardDescription>
            {t('translate.change_password_description')}
          </CardDescription>
        </CardHeader>
          ...
          >
            ...
            {success && (
              <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 px-4 py-3 rounded-lg flex items-center gap-3 animate-in fade-in slide-in-from-top-1">
                ...
                <p className="text-sm font-medium">
                  {t('translate.password_updated_successfully')}
                </p>
              </div>
            )}
      ...
      <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
        ...
        <ul className="text-sm text-blue-600/80 space-y-1 list-disc pl-4">
          <li>
            {t(
              'translate.password_requirement_min_length'
            )}
          </li>

          <li>
            {t(
              'translate.password_requirement_uppercase'
            )}
          </li>

          <li>
            {t(
              'translate.password_requirement_special_character'
            )}
          </li>

          <li>
            {t(
              'translate.password_requirement_previous'
            )}
          </li>
        </ul>
      </div>
